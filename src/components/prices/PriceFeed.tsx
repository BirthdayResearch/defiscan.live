  ...
  return (
    ...
    <div className='w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4'>
      <div className='bg-gray-50 rounded p-6 cursor-pointer'>
        <div className='flex'>
          {copy !== undefined ? (
            <Image src={require('cms/prices/images/tesla.png')} width={24} height={24} alt={copy.description} />
          ) : (
...
function isActive (price: prices.PriceFeed): boolean {
  return Math.abs(price.block.time - Date.now() / 1000) < 3600
}
