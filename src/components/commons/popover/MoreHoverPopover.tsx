...
export function MoreHoverPopover (props: PropsWithChildren<MoreHoverPopoverProps>): JSX.Element {
  return (
    <HoverPopover className={classNames('cursor-help group', props.className)} popover={props.description} placement={props.placement}>
      <div className='flex items-center' data-testid='MoreHoverPopover'>
        {props.children}
        <IoEllipsisHorizontalCircleOutline className={classNames('h-4 w-4 text-blue-500', { 'ml-1': props.children })} />
      </div>
    </HoverPopover>
  )
}
