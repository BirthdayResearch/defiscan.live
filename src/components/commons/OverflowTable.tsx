    ...
    <OverflowTableContext.Consumer>
      {(left) => (
        <div
          ...
          className={classNames('table-cell px-4 md:px-6 py-4 align-top bg-white dark:bg-gray-900 group-hover:bg-primary-50 dark:group-hover:bg-gray-800', props.className, {
            'sticky left-0': props.sticky!,
            'text-right': props.alignRight!
          })}
        >
