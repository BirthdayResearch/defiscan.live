  ...
  return (
    ...
    >
      <div className="table w-full border-collapse">
        <div className="table-row-group space-y-6">{props.children}</div>
      </div>
    </div>
  );
}
...
function Cell(
  ...
  return (
    <div
      data-testid={`${
        props.testId === undefined ? "AdaptiveTable.Cell" : props.testId
      }`}
      className={classNames(
    ...
    >
      ...
      <div className="py-5 px-6">{props.children}</div>
    </div>
  );
}
