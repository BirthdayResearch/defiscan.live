  ...
  return (
    <>
      ...
      <HeaderWrapper
        ...
        gradient={
          theme === "dark"
            ? "linear-gradient(rgba(23, 23, 23, 0) 25.4%, rgb(23, 23, 23) 94.76%)"
            : "linear-gradient(rgba(255, 255, 255, 0) 25.4%, rgb(255, 255, 255) 94.76%)"
        }
      ...
      >
        <Container className="h-full">
          <div className="h-full flex flex-wrap items-center justify-center pt-14 pb-16">
            ...
            >
              DeFiChain{" "}
              <span className="font-normal dark:text-gray-100">Explorer</span>
            </h1>
