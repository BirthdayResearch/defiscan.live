    ...
    <div className="mt-12" data-testid="LiquidityPoolList">
      <div className="flex justify-between">
        <h1
          ...
          data-testid="LiquidityPoolList.title"
        >
          Liquidity Pools
        </h1>
      </div>
      <div className="mt-6 flex flex-wrap -m-1">
        {liquidityPools.map((pool) => {
          return (
            <LiquidityPoolCard
              ...
              totalLiquidity={
                pool.totalLiquidity.usd !== undefined
                  ? pool.totalLiquidity.usd
                  : ""
              }
...
function LiquidityPoolCard(props: {
  poolId: string;
  ...
  return (
    <div className="w-full sm:w-1/2 xl:w-1/4 2xl:w-1/4 p-1">
      <div
        className="flex flex-col p-4 rounded border border-gray-200 space-y-3 dark:bg-gray-800 dark:border-gray-700"
        data-testid="LiquidityPoolCard"
      >
        <PoolPairSymbol
...
function LiquidityCardStat({
  ...
  return (
    <div className="table-row border-collapse text-sm">
      <div
        className="table-cell opacity-40 dark:opacity-100 dark:text-gray-400"
        data-testid={testid}
      >
        {label}
      </div>
      <div className="table-cell pl-2 md:pl-4 dark:text-gray-100">
        {children}
      </div>
    </div>
  );
