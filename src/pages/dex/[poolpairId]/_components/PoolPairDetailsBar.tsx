...
export function PoolPairDetailsBar (props: {poolpair: PoolPairData}): JSX.Element {
  ...
  return (
    <div className='mt-8 flex flex-1 flex-wrap p-4 rounded-lg border border-gray-200 dark:border-gray-700 justify-between dark:bg-gray-800' data-testid='PoolPairDetailsBar'>
      <PoolPairSymbolLocal
