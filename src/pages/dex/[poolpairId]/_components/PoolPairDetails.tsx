...
export function PoolPairDetails (props: { poolpair: PoolPairData }): JSX.Element {
  return (
    <div className='rounded-lg flex mt-4 flex-col p-6 bg-gray-50 w-full border border-gray-200 flex-1 dark:bg-gray-800 dark:border-gray-700' data-testid='PoolPairDetails'>
      <div className='mt-5'>
        ...
        <div className='mt-7 space-y-5' data-testid='PoolPairDetails.Token'>
          <div className='space-y-2.5' data-testid='PoolPairDetails.Token.Pool'>
            <span className='mb-1.5 text-sm text-gray-500 dark:text-gray-100'>Pooled Tokens</span>
            <TokenDetailsItem
          ...
          <div className='space-y-2.5' data-testid='PoolPairDetails.Token.Price'>
            <span className='mb-1.5 text-sm text-gray-500 dark:text-gray-100'>Price</span>
            <TokenDetailsItem
              tokenSymbol={props.poolpair.tokenA.symbol}
...
function TokenDetailsItem (props: {
  ...
  return (
    <div className='flex items-center justify-between text-gray-900' data-testid={props.testId}>
      <span className='flex items-center dark:text-gray-400'><TokenIcon className='mr-2 w-4 h-4' /> {props.displaySymbol}</span>
      <NumberFormat
        value={props.value}
        displayType='text'
        thousandSeparator
...
function TokenLiquidityItem (props: { title: string, value: string | number | undefined, testId: string }): JSX.Element {
  return (
    <div className='flex items-center justify-between' data-testid={props.testId}>
      <span className='text-sm text-gray-500 dark:text-gray-400'>{props.title}</span>
      <NumberFormat
        value={props.value}
        prefix='$'
        thousandSeparator
  ...
  return (
    <div className='flex-col flex-1 space-y-2.5 my-5' data-testid='PoolPairDetails.Apr'>
      <div className='mb-1.5 flex items-center' data-testid='APR'>
        <span className='text-sm font-medium text-gray-500 dark:text-gray-400'>APR</span>
        <NumberFormat
      ...
      <div className='flex items-center justify-between text-sm text-gray-500 dark:text-gray-400' data-testid='Rewards'>
        <span>Rewards</span>
        <NumberFormat
      ...
      <div className='flex items-center justify-between text-sm text-gray-500 dark:text-gray-400' data-testid='Commissions'>
...
function Divider (): JSX.Element {
  return (
    <div className='border-b border-gray-200 mt-8 dark:border-gray-700' />
  )
}
