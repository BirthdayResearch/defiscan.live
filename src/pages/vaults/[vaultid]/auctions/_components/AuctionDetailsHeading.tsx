...
export function AuctionDetailsHeading (props: { vault: LoanVaultLiquidated, batchIndex: string }): JSX.Element {
  return (
    <>
      ...
      <h2 className='text-xl font-semibold mt-8 dark:text-dark-gray-900' data-testid='AuctionDetails.Heading'>
        Auction Details
      </h2>
    </>
  )
