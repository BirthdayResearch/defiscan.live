...
export function LoanTotalInterestRate (props: LoanTotalInterestRateProps): JSX.Element {
  const api = useWhaleApiClient()
  const [loanTokenData, setLoanTokenData] = useState<LoanToken | undefined>(undefined)
  ...
  useEffect(() => {
    ...
    api.loan.getLoanToken(props.loanId).then(data => {
