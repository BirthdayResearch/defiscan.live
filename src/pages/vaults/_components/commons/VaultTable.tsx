        ...
        return (
          <Link href={{ pathname: `/vaults/${vault.vaultId}` }} key={vault.vaultId}>
            <a className='contents'>
              <VaultTableRow vault={vault} liquidatedVaultDerivedValues={calculateLiquidationValues(vault)} />
            </a>
          </Link>
        )
      })}
...
function VaultStatusInfo (): JSX.Element {
  return (
    <div
      className='p-3 space-y-2 font-normal text-sm bg-white text-left text-gray-900 rounded-lg border border-gray-100 shadow-md max-w-xs dark:bg-gray-800 dark:border-gray-700 dark:text-gray-dark-900'
    >
      <div>
...
function CollateralizationRatioMinInfo (): JSX.Element {
  return (
    <div
      className='px-3 py-3 font-normal text-sm bg-white text-left text-gray-900 rounded-lg border border-gray-100 shadow-md max-w-xs dark:bg-gray-800 dark:border-gray-700 dark:text-gray-dark-900'
    >
