    ...
    <OverflowTable.Row className="dark:text-gray-100">
      <OverflowTable.Cell>
        <AuctionTimeLeft
          ...
          testId="AuctionsTableRow.AuctionTimeLeft"
        />
      </OverflowTable.Cell>
      <OverflowTable.Cell>
        <div className="flex">
      ...
      <OverflowTable.Cell alignRight>
        <VaultTokenSymbols
          ...
          tokens={props.batch.collaterals}
...
export function MobileAuctionDetailsCard(
  ...
  return (
    <CardList.Card testId="MobileAuctionDetailCard">
      <CardList.Header
        path={`/vaults/${props.vault.vaultId}/auctions/${props.batch.index}`}
      >
        <div className="flex items-center font-medium text-gray-900 dark:text-gray-100">
          <TokenSymbol
            className="w-6 h-6 mr-1.5"
            data-testid="MobileAuctionDetailCard.TokenSymbol"
          />
          <span data-testid="MobileAuctionDetailCard.displaySymbol">
            {props.batch.loan.displaySymbol}
          </span>
        </div>
      </CardList.Header>
      ...
      <div
        ...
        data-testid="MobileAuctionDetailCard.AuctionTimeLeft"
      >
        <AuctionTimeLeft
          liquidationHeight={props.vault.liquidationHeight}
