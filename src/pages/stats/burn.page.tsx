...
export default function BurnPage ({
  ...
  return (
    <>
      ...
      <Container>
        <div className='text-2xl font-medium mt-10 mb-2 dark:text-gray-dark-900'>
          Payback Burn Stats
        </div>
        <div className='text-xl font-medium mt-6 mb-2 dark:text-gray-dark-900'>
          DFI
        </div>
        ...
        <div className='mt-5 bg-gray-100 p-6 border-gray-500 text-gray-600 dark:bg-gray-800 ark:border-gray-700 dark:text-gray-dark-900 rounded'>
