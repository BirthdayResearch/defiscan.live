...
export function AddressHeading(props: AddressHeadingProps): JSX.Element {
  return (
    <>
      <span
        className="leading-6 opacity-60 dark:text-dark-gray-900 dark:opacity-100"
        data-testid="title"
      >
        Address
      </span>
      ...
      <div className="flex items-center mt-1">
        <h1
          ...
          data-testid="AddressHeading.address"
        >
          {props.address}
        </h1>
...
export function AddressNotFoundHeading(
  ...
  return (
    <div
      ...
      data-testid="AddressHeading.AddressNotFoundHeading"
    >
      The requested address <code className="break-all">{address}</code> could
      not be found.
    </div>
  );
}
