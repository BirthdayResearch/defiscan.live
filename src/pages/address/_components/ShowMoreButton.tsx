...
export function ShowMoreButton (props: ShowMoreButtonProps): JSX.Element {
  ...
  return (
    ...
    >
      <button
        type='button'
        className='w-full md:w-1/3 py-2.5 text-primary-300 hover:text-primary-500 border border-primary-200 hover:border-primary-500 rounded dark:bg-gray-900 dark:border=gray-400 dark:text-darkprimary-500 dark:hover:border-gray-400'
      >
        SHOW MORE
      </button>
    </div>
