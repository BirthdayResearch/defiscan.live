...
export function BlockTransactions (props: InferGetServerSidePropsType<typeof getServerSideProps>): JSX.Element {
  const {
    block,
    transactions
  } = props
  ...
  return (
    <div>
      <h1 className='font-medium text-2xl mt-6 dark:text-white'>Transactions</h1>
