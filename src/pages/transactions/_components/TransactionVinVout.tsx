...
export function TransactionVinVout (props: TransactionVinVoutProps): JSX.Element {
  ...
  return (
    <>
      <h1 className='font-medium text-2xl mt-6 dark:text-white' data-testid='details-subtitle'>Details</h1>
...
function TransactionSummary (props: { transaction: Transaction, vins: TransactionVin[], fee: BigNumber }): JSX.Element {
  ...
  return (
    <div className='flex flex-col items-end justify-between mt-8 dark:text-white'>
