import { DfTx, PaybackLoan, TokenBalance } from '@defichain/jellyfish-transaction'
          ...
          <AdaptiveList.Row name={'Owner\'s Address'}>
            {(() => {
              if (address?.address !== undefined) {
                return (
                  <AddressLink address={address?.address} testId='DfTxPayBackLoan.OwnerAddress' className='break-all' />
                )
              }
              return 'N/A'
            })()}
