...
function Path (props: { pools: PoolId[], FromTokenSymbol: JSX.Element, ToTokenSymbol: JSX.Element }): JSX.Element {
  return (
    <div className='w-full lg:px-3 mt-4' data-testid='DfTxCompositeSwap.SwapPath'>
      <h2 className='my-3 font-medium dark:text-gray-dark-900' data-testid='DfTxCompositeSwap.SwapPathTitle'>Swap Path</h2>
      <div
      ...
      >
        ...
        <IoArrowForwardOutline size={18} className='dark:text-primary-dark-500' />
