...
export function DfTxPlaceAuctionBid (props: DfTxPlaceAuctionBidProps): JSX.Element {
      ...
      <div className='mt-5 flex flex-col space-y-6 items-start lg:flex-row lg:space-x-8 lg:space-y-0'>
        ...
        <div className='w-full lg:w-1/2'>
          ...
          <AdaptiveList className='w-full mt-1'>
            <AdaptiveList.Row name='Auction Batch' testId='DfTxPlaceAuctionBid.AuctionBatch'>
              {props.dftx.data.index}
            </AdaptiveList.Row>
            <AdaptiveList.Row name='Amount'>
              <div className='flex flex-row'>
                <span
                  data-testid='DfTxPlaceAuctionBid.Amount'
                >{props.dftx.data.tokenAmount.amount.toFixed(8)}
                </span>
                <TokenSymbol
                  tokenId={props.dftx.data.tokenAmount.token} className='ml-1'
