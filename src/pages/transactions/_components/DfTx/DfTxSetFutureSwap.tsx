  ...
  return (
    <>
      <div className='w-full lg:w-1/2 lg:pl-3 lg:pr-1.5' data-testid='DfTxCompositeSwap.SwapFrom'>
        ...
        <AdaptiveList>
          <AdaptiveList.Row name='Token'>
            <TokenSymbol tokenId={props.fromTokenId} testId='DfTxSetFutureSwap.fromAmountSymbol' symbolLeft />
          </AdaptiveList.Row>
          <AdaptiveList.Row name='Amount'>
            <span data-testid='DfTxSetFutureSwap.fromAmount'>{props.fromAmount.toFixed(8)}</span>
          </AdaptiveList.Row>
        </AdaptiveList>
      </div>
      ...
      <div className='w-full lg:w-1/2 lg:pr-3 lg:pl-1.5 mt-4 lg:mt-0' data-testid='DfTxCompositeSwap.SwapTo'>
        ...
        <AdaptiveList>
          <AdaptiveList.Row name='Token'>
            <TokenSymbol tokenId={props.toTokenId} testId='DfTxSetFutureSwap.toAmountSymbol' symbolLeft />
          </AdaptiveList.Row>
        </AdaptiveList>
      </div>
    </>
