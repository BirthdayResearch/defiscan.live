              ...
              case 'LP_LOAN_TOKEN_SPLITS': {
                ...
                return (
                  <AdaptiveList className='w-full lg:w-1/2'>
                    <AdaptiveList.Row name='Activation Height' testId='DfTxSetGovernanceHeight.ActivationHeight'>
                      {props.dftx.data.activationHeight}
                    </AdaptiveList.Row>
                    <AdaptiveList.Row name='Governance Key' testId='DfTxSetGovernanceHeight.Key'>
                      {governanceUnmapped.key}
                    </AdaptiveList.Row>
                    <AdaptiveList.Row
                      name='Value' testId='DfTxSetGovernanceHeight.Value'
