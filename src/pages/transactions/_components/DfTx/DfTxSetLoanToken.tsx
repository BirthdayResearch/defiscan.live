    ...
    <div>
      ...
      <div className='mt-5 flex flex-col space-y-6 items-start lg:flex-row lg:space-x-8 lg:space-y-0'>
        <AdaptiveList className='w-full lg:w-1/2'>
          <AdaptiveList.Row name='Token Symbol' testId='DfTxSetLoanToken.TokenSymbol'>
            {props.dftx.data.symbol}
          </AdaptiveList.Row>
          <AdaptiveList.Row name='Token Name' testId='DfTxSetLoanToken.TokenName'>
            {props.dftx.data.name}
          </AdaptiveList.Row>
        </AdaptiveList>
        <AdaptiveList className='w-full lg:w-1/2'>
          <AdaptiveList.Row name='Currency Pair' testId='DfTxSetLoanToken.CurrencyPair'>
