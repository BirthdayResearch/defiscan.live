  ...
  return (
    <section data-testid="FooterSectionSocial">
      <h3
        ...
        data-testid="FooterSectionSocial.Header"
      >
        Social
      </h3>
      <div
        className="flex flex-wrap mt-3"
        data-testid="FooterSectionSocial.div"
      >
        <FooterSocialRow
        ...
        <FooterSocialRow
          ...
          text="GitHub"
          testId="FooterSectionSocial.Github"
        >
          <FaGithub size={24} />
        </FooterSocialRow>
        <FooterSocialRow
          ...
          text="YouTube"
          testId="FooterSectionSocial.YouTube"
        >
          <FaYoutube size={24} />
        </FooterSocialRow>
        <FooterSocialRow
        ...
        <FooterSocialRow
          ...
          text="Telegram"
          testId="FooterSectionSocial.Telegram"
        >
          <FaTelegram size={24} />
        </FooterSocialRow>
        <FooterSocialRow
...
function FooterSectionSitemap(): JSX.Element {
  return (
    <section data-testid="FooterSectionSitemap">
      <h3
        className="text-2xl font-semibold dark:text-dark-gray-900"
        data-testid="FooterSectionSitemap.Header"
      >
        Scan
      </h3>
      <div
        className="flex flex-wrap mt-3"
        data-testid="FooterSectionSitemap.div"
      >
        ...
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
            pathname="/blocks"
            text="Blocks"
            testId="FooterSectionSitemap.Blocks"
          />
        </div>
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
            pathname="/vaults"
            text="Vaults"
            testId="FooterSectionSitemap.Vaults"
          />
        </div>
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
            pathname="/auctions"
            text="Auctions"
            testId="FooterSectionSitemap.Auctions"
          />
        </div>
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
            pathname="/oracles"
            text="Oracles"
            testId="FooterSectionSitemap.Oracles"
          />
        </div>
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
            pathname="/tokens"
            text="Tokens"
            testId="FooterSectionSitemap.Tokens"
          />
        </div>
        <div className="space-x-2 py-2 w-1/2">
          <FooterInternalLink
...
function FooterSectionAbout(): JSX.Element {
  const { net } = useSelector((state: RootState) => state.stats);
    ...
    <section className="max-w-md" data-testid="FooterSectionAbout">
      <div className="text-sm text-gray-500 dark:text-gray-400">
        <span data-testid="FooterSectionAbout.Desc">
          DeFi Blockchain’s primary vision is to enable decentralized finance
          with Bitcoin-grade security, strength and immutability. It's a
          blockchain dedicated to fast, intelligent and transparent financial
          services, accessible by everyone. For more info, visit
        </span>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          data-testid="FooterSectionAbout.DFCLink"
        >
          DeFiChain.com
        </a>
      </div>
          ...
          >
            <div className="text-sm bg-white text-gray-900 p-2 dark:bg-dark-gray-200 dark:text-dark-gray-900 rounded cursor-help">
              <span className="font-medium">
                {net.subversion?.replaceAll("/", "").replace(":", " Node v")}
              </span>
            </div>
          </HoverPopover>
        )}
