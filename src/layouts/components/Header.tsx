    ...
    <Link href={{ pathname: props.pathname }}>
      <a
        className={classNames(props.className, {
          "text-primary-500 dark:text-dark-50":
      ...
      >
        <div
          className={classNames(
            "inline m-2 text-lg pb-0.5 hover:text-primary-500 dark:hover:text-dark-50  cursor-pointer",
            {
              "border-b-2 border-primary-500 dark:border-dark-50":
                router.pathname === props.pathname,
            }
          )}
        >
