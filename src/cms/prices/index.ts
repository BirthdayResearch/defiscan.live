...
export const PRICES: Record<string, PriceCopy> = {
  'TSLA-USD': {
    ...
    icon: require('cms/prices/images/tesla.png')
  },
  'XCU-USD': {
    id: 'XCU-USD',
    type: 'COMMODITY',
    ...
    icon: require('cms/prices/images/xcu.png')
  },
  'XAU-USD': {
    id: 'XAU-USD',
    type: 'COMMODITY',
    ...
    icon: require('cms/prices/images/xau.png')
  },
  'XAG-USD': {
    id: 'XAG-USD',
    type: 'COMMODITY',
    ...
    icon: require('cms/prices/images/xag.png')
  },
  'SGD-USD': {
    id: 'SGD-USD',
    type: 'FOREX',
    description: 'Singapore Dollar',
    icon: require('cms/prices/images/sgd.png')
  },
  'EUR-USD': {
    id: 'EUR-USD',
    type: 'FOREX',
    description: 'The Euro',
    icon: require('cms/prices/images/eur.png')
  },
  'BCO-USD': {
    id: 'BCO-USD',
    type: 'COMMODITY',
    description: 'Brent Crude Oil',
    icon: require('cms/prices/images/bco.png')
  },
  'UBER-USD': {
    id: 'UBER-USD',
    type: 'STOCKS',
    ...
    icon: require('cms/prices/images/uber.png')
  },
  'GME-USD': {
    id: 'GME-USD',
    type: 'STOCKS',
    ...
    icon: require('cms/prices/images/gme.png')
  },
  'AMD-USD': {
    id: 'AMD-USD',
    type: 'STOCKS',
  ...
  'NVDA-USD': {
    ...
    icon: require('cms/prices/images/nvda.png')
  },
  'MSTR-USD': {
    id: 'MSTR-USD',
    type: 'STOCKS',
    ...
    icon: require('cms/prices/images/mstr.png')
  },
  'GOOGL-USD': {
    id: 'GOOGL-USD',
    type: 'STOCKS',
    ...
    icon: require('cms/prices/images/googl.png')
  },
  'FB-USD': {
    id: 'FB-USD',
    type: 'STOCKS',
  ...
  'AMZN-USD': {
    ...
    icon: require('cms/prices/images/amzn.png')
  },
  'AAPL-USD': {
    id: 'AAPL-USD',
    type: 'STOCKS',
    ...
    icon: require('cms/prices/images/appl.png')
  },
  'OTGLY-USD': {
    id: 'OTGLY-USD',
    type: 'STOCKS',
    description: 'CD Projekt S.A. ADR',
    icon: require('cms/prices/images/otgly.png')
  }
}
