context('/transactions/[txid] - DfTx ICX Claim DFCHTLC  on desktop', () => {
  before(() => {
    cy.visit('/transactions/2ab05dea3ca27c37fecb014201f81d2e6098986b2ee387a766f1f69723f49ad9?network=MainNet')
  })
  ...
  it('should have DfTxICXClaimDFCHTLC Seed', () => {
    cy.findByTestId('DfTxICXClaimDFCHTLC.Seed').should('have.text', 'c184b0239f4198763fdf6289a93616f59b388b81ca9fb840ae7d9b067fb1663d')
  })
})
