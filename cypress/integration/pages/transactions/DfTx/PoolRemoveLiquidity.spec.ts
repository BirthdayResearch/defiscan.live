context('/transactions/[txid] - DfTx Pool Remove Liquidity on desktop', () => {
    ...
    it('should have DfTx type', () => {
        cy.findByTestId('DfTxHeader.Subtitle').contains('Type:Pool Remove Liquidity')
    })
    ...
    it('should have DfTxPoolRemoveLiquidity Amount', () => {
        cy.findByTestId('DfTxPoolRemoveLiquidity.Amount').should('have.text', '1064.54406915 DFI')
    })
})
