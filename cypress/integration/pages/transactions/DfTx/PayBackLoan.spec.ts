context('/transactions/[txid] - DfTx Pay back Loan on Desktop', () => {
  ...
  it('should DfTxPayBackLoan Vault ID ', function () {
    cy.findByTestId('DfTxPayBackLoan.VaultId').should('have.text', 'e2329c45aad2fcbbb20d0d38d3b153a8a0344cdb2c57649269c3eb8d4419667c')
  })

  it('should DfTxPayBackLoan Owner\'s Address', function () {
    cy.findByTestId('DfTxPayBackLoan.OwnerAddress').should('have.text', 'dUL7BmAkZy8W48e66dmibwoppGA8YYw3Pr')
  })
  ...
  it('should have DfTxPayBackLoan Amount', () => {
    cy.findByTestId('DfTxPayBackLoan.Amount').should('have.text', '2000.00000000')
  })
})
