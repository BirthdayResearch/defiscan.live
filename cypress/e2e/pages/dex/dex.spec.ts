context("/dex on macbook-16", () => {
  ...
  it("should have at least 9 pairs listed", () => {
  ...
  it("should have sort button for table view", () => {
    cy.findByTestId("OverflowTable.Header").then((ele) => {
      cy.wrap(ele)
        .findByText("Total Liquidity")
        .findByTestId("OverflowTable.SortButton")
        .should("exist");
      cy.wrap(ele)
        .findByText("Volume (24H)")
        .findByTestId("OverflowTable.SortButton")
        .should("exist");
      cy.wrap(ele)
        .findByText("APR")
  ...
  it("should sort row by chosen order", () => {
    cy.findByTestId("OverflowTable.Header").within(() => {
      cy.findByText("Total Liquidity")
        .findByTestId("OverflowTable.SortButton")
        .click();
    });
...
context("/dex on iphone-x", () => {
  ...
  it("should have sort button for card view", () => {
    ...
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(0)
      .findByText("Total Liquidity (High to Low)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(1)
    ...
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(2)
      .findByText("Volume (High to Low)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(3)
      .findByText("Volume (Low to High)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(4)
      .findByText("APR (High to Low)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(5)
      .findByText("APR (Low to High)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(6)
      .findByText("Primary Token Price (High to Low)")
      .should("exist");
    cy.findAllByTestId("CardList.DropDownSortOption")
      .eq(7)
      .findByText("Primary Token Price (Low to High)")
      .should("exist");
  });
  ...
  it("should sort cards by chosen order", () => {
    ...
    cy.findAllByTestId("PoolPairsCard").each(($el) => {
      cy.wrap($el).within(() => {
        cy.findAllByTestId("PoolPairsCard.CardList.TotalLiquidity").then(
          ($ele) => {
