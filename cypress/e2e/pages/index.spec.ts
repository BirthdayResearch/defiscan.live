context("/ on macbook-16", () => {
  ...
  it("should have Transactions", () => {
    ...
    cy.findByTestId("Desktop.TransactionList").within(() => {
      cy.findByTestId("Desktop.TransactionList.Title")
        .should("be.visible")
  ...
  it("should have Blocks", () => {
    ...
    cy.findByTestId("Desktop.BlocksList").within(() => {
      cy.findByTestId("Desktop.BlocksList.Title")
        .should("be.visible")
    ...
    cy.findByTestId("BlocksList.viewAllBlocksButton")
      .should("be.visible")
  ...
  it("should have LiquidityPools", () => {
    ...
    cy.findByTestId("LiquidityPoolList.title")
      .should("be.visible")
    ...
    cy.findByTestId("LiquidityPoolList.viewAllPoolsButton")
      .should("be.visible")
...
context("/ on iphone-x", () => {
  ...
  it("should have Transactions", () => {
    ...
    cy.findByTestId("Mobile.TransactionList").within(() => {
      cy.findByTestId("CollapsibleSection.Heading")
        .should("be.visible")
        .should("have.text", "Latest Transactions");
