context('/transactions/[txid] - DfTx Appoint Oracle on desktop', () => {
  before(() => {
    cy.visit('/transactions/a47feba58a644d07603f65966d8779e5c87d85053c885fd91626a502cb92a367?network=MainNet')
  })
  ...
  it('should have DfTxAppointOracle TSLA Token', function () {
  ...
  it('should have DfTxAppointOracle TSLA Currency', function () {
    cy.findByTestId('DfTxAppointOracle.TSLACurrency').should('have.text', 'USD')
  })
})
