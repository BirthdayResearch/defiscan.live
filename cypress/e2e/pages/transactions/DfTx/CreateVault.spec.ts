context('/transaction/[txid] - Dftx Create Vault on Desktop', () => {
  before(() => {
    cy.visit('/transactions/3dc1257fdcd34e03e634b70dea7e04b96c9ef5d6787c7fc42094b728c8bf1566')
  })
  ...
  it('should have DfTxCreateVault Owners Address', () => {
    cy.findByTestId('DfTxCreateVault.OwnersAddress').should('have.text', 'dWNDpnGPfhu5yCrkvqqjk2fA4FnHv6rqa5')
  })
