context('/transactions/[txid] - Take Loan on desktop', () => {
  ...
  it('should have a vaultId', () => {
    cy.findByTestId('DfTxTakeLoan.VaultId').contains('27a8209d6b851d9aa4b1402aa5e50368c40aaf360eb547a905e1d8b4c5a2e2d9')
  })

  it('should have an address to', () => {
    cy.findByTestId('DfTxTakeLoan.Address').contains('dFgD1hmyZ2KitHzNLzvGoFLn548fqxZE7E')
  })
