context('/transactions/[txid] - DfTx ICX Make Offer on desktop', () => {
  before(() => {
    cy.visit('/transactions/9ffb051a64d9c5600d0432e83bfbac81fd0645172ed8e48ecaa5157b3f4fb16f?network=MainNet')
  })
  ...
  it('should have DfTxICXMakeOffer amount', () => {
    cy.findByTestId('DfTxICXMakeOffer.Amount').should('have.text', '0.10000000')
  })

  it('should have DfTxICXMakeOffer TakerFee', () => {
    cy.findByTestId('DfTxICXMakeOffer.TakerFee').should('have.text', '0.00000000')
  })
